...
from tns.astrocyte.space_colonization import SpaceColonization
from tns.astrocyte.space_colonization import SpaceColonizationTarget


GROWTH_ALGORITHMS = {'tmd_space_colonization': SpaceColonization,
                     'tmd_space_colonization_target': SpaceColonizationTarget}

SECTION_GROWERS = {'tmd_space_colonization': SectionSpatialGrower,
...
class TreeGrowerSpaceColonization(TreeGrower):
    ...
    def _initialize_algorithm(self):
        ...
        section = self.add_section(parent=None,
    ...
    def add_section(self, parent, direction, first_point, stop,
                    pathlength, process=None, children=0):
